...
public class Coviddata implements Serializable {
    ...
    public Coviddata(Integer id, Integer years, Integer weeknum, String province, Integer newCase, Integer totalCase, Integer newCaseExcludeabroad, Integer totalCaseExcludeabroad, Integer newDeath, Integer totalDeath, String updateDate) {
        this.id = id;
        this.years = years;
    ...
    public String toString() {
        return "database.Coviddata[ id=" + id + " ]";
    }
